...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "PhotoGuessr" },
      { name: "description", content: "Multiplayer photo guessing party game." },
      { name: "author", content: "PhotoGuessr" },
      { name: "theme-color", content: "#000000" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black" },
      { name: "apple-mobile-web-app-title", content: "PhotoGuessr" },
      { property: "og:title", content: "PhotoGuessr" },
      { property: "og:description", content: "Multiplayer photo guessing party game." },
